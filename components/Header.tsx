...
import MaticLogo from "../img/matic-logo.svg"
type NavProps = {
            ...
            <div className="self-center hidden sm:block">
                <ul className="flex space-x-4 mr-auto">
                    <li className="bg-gray-700 px-4 py-1 rounded  ml-auto">
                        ...
                        {displayName.length <= 0 && (
                            <button className={['flex cursor-pointer  font-body'].join(' ')} onClick={connectWallet}>
                                <MaticLogo className="mr-2" /> Connect Polygon Wallet
                            </button>
                        )}
                    </li>
                </ul>
